    ...
    <header className="header w-full px-6 py-4">
      ...
      <div className="blf-col flex flex-col items-center relative">
        ...
        <img
          ...
          className="hover-zoom w-[130px] transition-transform duration-500"
          alt="BLF Logo"
        />
        ...
        <img
          ...
          className="hover-zoom w-[60px] absolute top-[110px] left-[140px] animate-fly md:w-[65px] transition-transform duration-500"
          alt="Butterfly"
        />
      </div>
      ...
      <div className="auth-col flex flex-col items-center gap-1">
        <button className="reg-btn hover-zoom transition-transform duration-500">Register</button>
        <button className="login-btn hover-zoom transition-transform duration-500">Login</button>
        <div className="forgot text-xs mt-1">Forgot Password</div>
      </div>

      {/* COLUMN 5 — LANGUAGE */}
      <div className="lang-col text-center">
        <select className="lang-select hover-zoom transition-transform duration-500">
